...
└── docs/
    ├── 1-concept.md      # Sections 3.1, 3.2, 3.4, 3.5 (The "Why" and "What")
    ├── 2-education.md    # Sections 3.3, 3.6 (The Learning Science)
    ├── 3-requirements.md # Section 3.7 (Functional/Non-functional specifications)
    ├── 4-design.md       # Section 3.8 (Diagrams, mechanics, system design)
